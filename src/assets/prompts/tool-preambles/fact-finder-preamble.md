...
2.  **Prioritize Information Sources::**
      * **a. Information Provided from User's Documents (VERY High Weight):**
          * **Always examine this first.** If the answer, or highly relevant context, is directly present in the information provided from user's documents , use it.
...
**Information Provided from User's Documents**
${ExplicitlyProvided}
